FROM registry.access.redhat.com/ubi9/go-toolset:1.25.5-1770654497@sha256:82b82ecf4aedf67c4369849047c2680dba755fe57547bbb05eca211b22038e29 as osdk-builder
...
FROM registry.access.redhat.com/ubi9/go-toolset:1.25.5-1770654497@sha256:82b82ecf4aedf67c4369849047c2680dba755fe57547bbb05eca211b22038e29 as opm-builder
...
FROM registry.access.redhat.com/ubi9/go-toolset:1.25.5-1770654497@sha256:82b82ecf4aedf67c4369849047c2680dba755fe57547bbb05eca211b22038e29 as kustomize-builder
...
FROM registry.access.redhat.com/ubi9/go-toolset:1.25.5-1770654497@sha256:82b82ecf4aedf67c4369849047c2680dba755fe57547bbb05eca211b22038e29 as controller-gen-builder
...
FROM registry.access.redhat.com/ubi9/go-toolset:1.25.5-1770654497@sha256:82b82ecf4aedf67c4369849047c2680dba755fe57547bbb05eca211b22038e29 as yq-builder

COPY --chown=default ./yq/. /opt/app-root/src/
WORKDIR /opt/app-root/src
RUN ls -l && CGO_ENABLED=0 GOOS=linux go build -a -o yq .

FROM registry.access.redhat.com/ubi9/go-toolset:1.25.5-1770654497@sha256:82b82ecf4aedf67c4369849047c2680dba755fe57547bbb05eca211b22038e29
